...
@section('content')
    <div class="header-content">
        ...
        <form class="search-box">
            <input type="text" class="form-control" placeholder="Nhập tên nhà cung cấp" name="search">
                        ...
                        <div class="d-flex justify-content-center" style="gap: 10px">
                            ...
                            <form action="{{ route('supplier.delete', $supplier->id) }}" method="POST"
                                ...
                                <button type="submit" class="btn btn-danger"
                                    onclick="return confirm('Bạn có muốn xóa nhà cung cấp này không?');">Xóa</button>
                            </form>
                        </div>
                    </td>
                </tr>
